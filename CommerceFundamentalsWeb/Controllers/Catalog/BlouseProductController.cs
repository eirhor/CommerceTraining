...
namespace CommerceFundamentalsWeb.Controllers.Catalog
{
    ...
    {
        public BlouseProductController(IContentLoader contentLoader, IUrlResolver urlResolver, AssetUrlResolver assetUrlResolver, ThumbnailUrlResolver thumbnailUrlResolver) :
